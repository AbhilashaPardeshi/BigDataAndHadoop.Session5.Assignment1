 ...
 * 
 * @author abhilasha
 * Map-reduce program to find sales of televisions per company, using a partitioner 
 */
public class TelevisionSalesP 
{
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException 
	{
		...
		job.setJarByClass(TelevisionSalesP.class);
		...
		job.setMapperClass(TelevisionSalesPMapper.class);
		job.setReducerClass(TelevisionSalesPReducer.class);
		job.setPartitionerClass(TelevisionSalesPPartitioner.class);
